...
public class RegistrationController {
    ...
    Registration assignRegistrationToCourse(@PathVariable Long numRegistration, @PathVariable Long numCourse) {
        return courseServices.assignRegistrationToCourse(numRegistration, numCourse);
    }
    @PostMapping("/add-and-assign")
    public Registration addRegistrationAndAssignToSkierAndCourse(@RequestBody Registration registration, @RequestParam Long numSkier, @RequestParam Long numCourse) {
